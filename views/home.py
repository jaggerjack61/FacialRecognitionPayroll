...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.employeeView = QtWidgets.QListView(self.tab)
        ...
        self.lineEdit.setGeometry(QtCore.QRect(150, 130, 531, 25))
        self.lineEdit.setObjectName("lineEdit")
        self.timeEdit = QtWidgets.QTimeEdit(self.tab_4)
        self.timeEdit.setGeometry(QtCore.QRect(150, 280, 118, 26))
        self.timeEdit.setObjectName("timeEdit")
        self.comboBox = QtWidgets.QComboBox(self.tab_4)
        self.comboBox.setGeometry(QtCore.QRect(150, 210, 201, 25))
        self.comboBox.setObjectName("comboBox")
        self.comboBox.addItem("")
        self.comboBox.addItem("")
        self.timeEdit_2 = QtWidgets.QTimeEdit(self.tab_4)
        self.timeEdit_2.setGeometry(QtCore.QRect(560, 280, 118, 26))
        self.timeEdit_2.setObjectName("timeEdit_2")
        self.createShift = QtWidgets.QPushButton(self.tab_4)
        self.createShift.setGeometry(QtCore.QRect(270, 410, 221, 25))
        self.createShift.setObjectName("createShift")
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(210, 90, 501, 25))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.lineEdit_3 = QtWidgets.QLineEdit(self.tab_6)
        self.lineEdit_3.setGeometry(QtCore.QRect(210, 200, 501, 25))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit_4 = QtWidgets.QLineEdit(self.tab_6)
        self.lineEdit_4.setGeometry(QtCore.QRect(210, 300, 501, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "Overtime"))
        self.createShift.setText(_translate("MainWindow", "Create Shift"))
